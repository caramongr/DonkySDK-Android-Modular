...
public class PushLogicController {
    ...
    public PendingIntent createPendingIntent(SimplePushData.ButtonSetAction buttonSetAction, SimplePushData simplePushData, int notificationId) {
        ...
        if (DonkyPushLogic.isInitialised()) {
            ...
            Integer pendingIntentId = new Integer(Math.abs(new Random().nextInt(Integer.MAX_VALUE)));
    ...
    public void reportPushNotificationClicked(Intent intent) {
        ...
        DonkyNetworkController.getInstance().queueClientNotification(ClientNotification.createInteractionResultNotification(buttonSetAction, simplePushData));
