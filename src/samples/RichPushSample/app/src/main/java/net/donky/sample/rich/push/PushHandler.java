...
public class PushHandler {
    ...
    void handleRichMessageEvent(Context context, RichMessageEvent event) {
        ...
        if (event != null) {
            ...
            for (RichMessage richMessage : richMessages) {
                notificationManager.notify(richMessage.getMessageId().hashCode(), buildRemoteNotification(context, notificationManager, richMessage));
            }
     ...
     */
    private Notification buildRemoteNotification(Context context, NotificationManager notificationManager, RichMessage richMessage) {
