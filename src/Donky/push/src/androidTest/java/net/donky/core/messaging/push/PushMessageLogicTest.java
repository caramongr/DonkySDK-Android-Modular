...
import net.donky.core.messaging.push.mock.MockDonkyEventListener;
import net.donky.core.messaging.push.mock.MockDonkyListener;
import net.donky.core.messaging.push.mock.MockOutboundNotificationBatchListener;
import net.donky.core.messaging.push.mock.MockServerNotification;
import net.donky.core.messaging.push.mock.MockSimplePushData;
...
public class PushMessageLogicTest extends ApplicationTestCase<Application> {
    ...
    protected void setUp() throws Exception {
        ...
        DonkyPush.initialiseDonkyPush(getApplication(), true, listenerA);
    ...
    public void testHandleServerNotification() throws InterruptedException {
        ...
        new SimplePushHandler().handleSimplePushMessage(getContext(), true, new SimplePushUIConfiguration(getContext()), serverNotifications);
